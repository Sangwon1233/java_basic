...
//			break;
//			//		case 3:
////			Set<String> name =new TreeSet<>();//이름
...
////		case 4:
////			tmp = totalSortedStudents;
////			Set<Integer> set =new TreeSet<>((i1,i2) -> i2-i1);//숫자			
////			break;
//		default:
//			System.out.println("????");
//			break;
...
//		for(int i = 0 ; i < students.size(); i++) {
//			// 비교 반복
//			for(int j = 0 ; j < students.size(); j++) { // 0,1,2,3
//				// 값 비교 자리 교환
//				boolean condition = false;
//				switch (type) {
//				case 0:
...
//	private int cnt;
	...
	// 학생 등록
	public void add() {
		int no = StudentUtils.next("국어", "영어", "수학","학번");
		if(findBy(no) != null) {
			throw new RuntimeException("중복되지 않는 학번을 입력하세요");
		}
		Function<String, Integer> name = name1->Integer.parseInt(name1);
		Function<Integer> kor = kor1::Integer;
		Function<Integer> eng = eng1::Integer;
		Function<Integer> mat = mat1::Integer;
		
//		String name = checkName(nextLine("이름"));
//		int kor = checkRange(next("국어"));
//		int eng = checkRange(next("영어"));
//		int mat = checkRange(next("수학"));
